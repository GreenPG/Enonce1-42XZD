...
function createStateActions(store) {
    return {
        ...
        getSection: function (sectionUid) {
            return store.survey.sections.find(function (section) {
                return section.uid === sectionUid;
            });
        },
        ...
        getSectionIndex: function () {
            return store.survey.sections.findIndex(function (section) {
                return section.uid === store.sectionUid;
            });
        },
        ...
        setEntryData: function (data) {
            Object.entries(data).forEach(function (pair) {
                return (store.entry[pair[0]] = pair[1]);
            });
            this.persist();
        },
        ...
        getEntryDataAsFormData: function () {
            ...
            Object.entries(store.entry).forEach(function (pair) {
                pair[1].forEach(function (value) {
                    return formData.append(pair[0], value);
                });
            });
            return formData;
        },
        ...
        restore: function (element) {
            ...
            store.variables =
                (storedState === null || storedState === void 0 ? void 0 : storedState.variables) || store.variables;
            store.lastEntry =
                (storedState === null || storedState === void 0 ? void 0 : storedState.lastEntry) || store.lastEntry;
            store.navigation =
                (storedState === null || storedState === void 0 ? void 0 : storedState.navigation) || store.navigation;
            store.sectionUid = !this.canRestart()
                ? "thankyou"
                : (storedState === null || storedState === void 0 ? void 0 : storedState.sectionUid) ||
                  store.sectionUid;
            Object.entries(store.entry).forEach(function (pair) {
                ...
                return __generator(this, function (_a) {
                    return [
                        ...
                        jQuery
                            ...
                            .always(function (e) {
                                return (e.responseJSON = jQuery.parseJSON(e.responseText));
                            }),
                    ];
                });
            });
        ...
        submitEntry: function (entryFormData) {
            if (entryFormData === void 0) {
                entryFormData = this.getEntryDataAsFormData();
            }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [
...
var Question = {
    ...
    computed: {
        question: function () {
            var _this = this;
            var _a, _b;
            return (_b = (_a = this.section) === null || _a === void 0 ? void 0 : _a.blocks) === null || _b === void 0
                ? void 0
                : _b.find(function (question) {
                      return question.uid === _this.uid;
                  });
        },
        isRequired: function () {
            var _a, _b, _c;
            return (_c =
                (_b = (_a = this.question) === null || _a === void 0 ? void 0 : _a.field.validations) === null ||
                _b === void 0
                    ? void 0
                    : _b.required) === null || _c === void 0
                ? void 0
                : _c.enabled;
        },
        error: function () {
...
var SectionItem = {
    ...
    methods: {
        ...
        input: function ($event) {
            ...
            var variableValue =
                $event.target.dataset.variableValue || ($event.target.type === "file" ? "" : $event.target.value);
            if ($event.target.tagName === "SELECT") {
                variableValue = $event.target.querySelector('option[value="' + variableValue + '"]').innerText;
            }
            if ($event.target.tagName === "INPUT" && $event.target.type === "checkbox") {
                variableValue = [];
                this.$el
                    .querySelectorAll('input[name="' + $event.target.name + '"]:checked')
                    .forEach(function (checkbox) {
                        return variableValue.push(checkbox.dataset.variableValue);
                    });
    ...
    methods: {
        ...
        input: function (_a) {
            var name = _a.name,
                ...
                _b = _a.checked,
                checked = _b === void 0 ? true : _b;
            if (name.endsWith("[]")) {
                value = this.$actions
                    .getEntryDataItem(name)
                    .concat([value])
                    .filter(function (item, position, entryDataItem) {
                        return entryDataItem.indexOf(item) == position;
                    })
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            if (
                                !(
                                    (next === null || next === void 0 ? void 0 : next.action) === "next" ||
                                    (next === null || next === void 0 ? void 0 : next.action) === "section"
                                )
                            )
                                return [3, 2];
                            ...
                            return [3, 4];
                        case 2:
                            if (!((next === null || next === void 0 ? void 0 : next.action) === "submit"))
                                return [3, 4];
                        ...
                        case 3:
                            ...
                            if (entry === null || entry === void 0 ? void 0 : entry.uid) {
                                ...
                                if (
                                    (_b = entry === null || entry === void 0 ? void 0 : entry.data) === null ||
                                    _b === void 0
                                        ? void 0
                                        : _b.scoring
                                ) {
                                ...
                                if (
                                    this.survey.settings.redirection.enabled &&
                                    this.survey.settings.redirection.url &&
                                    this.survey.settings.redirection.url !== ""
                                ) {
                                    window.open(this.survey.settings.redirection.url);
                                }
                            }
                            _c.label = 4;
                        case 4:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (response.success) {
                                this.$nextTick(function () {
                                    return _this.$el.scrollIntoView({ behavior: "smooth" });
                                });
                        ...
                        case 3:
                            e_1 = _b.sent();
                            this.$actions.stopLoading();
                            this.$actions.setGlobalError(
                                ((_a = e_1.responseJSON) === null || _a === void 0 ? void 0 : _a.error) ||
                                    (e_1 === null || e_1 === void 0 ? void 0 : e_1.message) ||
                                    (e_1 === null || e_1 === void 0 ? void 0 : e_1.statusText) ||
                                    (e_1 === null || e_1 === void 0 ? void 0 : e_1.responseText)
                            );
                            Object.entries(e_1.responseJSON.data).forEach(function (pair) {
                                var _a;
                                return _this.$actions.setFieldError(
                                    pair[0],
                                    (_a = pair[1]) === null || _a === void 0 ? void 0 : _a.join("\n")
                                );
                            });
                            this.$nextTick(function () {
                                return _this.$el.scrollIntoView({ behavior: "smooth" });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            this.$actions.stopLoading();
                            this.$actions.setGlobalError(
                                ((_a = e_2.responseJSON) === null || _a === void 0 ? void 0 : _a.error) ||
                                    (e_2 === null || e_2 === void 0 ? void 0 : e_2.message) ||
                                    (e_2 === null || e_2 === void 0 ? void 0 : e_2.statusText) ||
                                    (e_2 === null || e_2 === void 0 ? void 0 : e_2.responseText)
                            );
                            Object.entries(e_2.responseJSON.data).forEach(function (pair) {
                                var _a;
                                return _this.$actions.setFieldError(
                                    pair[0],
                                    (_a = pair[1]) === null || _a === void 0 ? void 0 : _a.join("\n")
...
document.querySelectorAll(".totalsurvey-wrapper").forEach(function (wrapperElement) {
    ...
    host.shadowRoot.querySelectorAll("survey-style, survey-link, survey-script").forEach(function (el) {
        ...
        el.getAttributeNames().forEach(function (name) {
            return style.setAttribute(name, el.getAttribute(name));
        });
        el.after(style);
        el.remove();
    });
